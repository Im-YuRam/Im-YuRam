...
> ⚠️ **【重要】ポートフォリオ移行のお知らせ / Notice of Portfolio Update**
>
> こちらのポートフォリオは**旧バージョン（旧版）**となります。
> 最新の実績や修正を反映した新しいポートフォリオサイトを公開しましたので、今後は以下のリンクより新しいページをご確認ください。
>
> 👉 **[新しいポートフォリオサイトを確認する (New Portfolio)](https://Im-YuRam.github.io/)**
...
| :--- | :--- |
| **🎂 Age** | 22歳 (2003年生まれ) |
| **🏫 University** | 千葉工業大学 先進工学研究科 知能メディア工学専攻 |
...
### 🛠 Skills & Proficiency
> **Proficiency Guide**
> - ★★★★★ : **実務レベル** (独力で複雑な機能も実装可能。実務に近い経験あり。)
> - ★★★★☆ : **応用レベル** (複雑すぎない機能であれば、独力で実装できる。)
> - ★★★☆☆ : **標準レベル** (基本的な機能であれば、独力で実装できる。)
> - ★★☆☆☆ : **基礎レベル** (文法や基本操作は理解している。実装には調べ学習やサポートが必要。)
> - ★☆☆☆☆ : **学習中** (チュートリアル完了レベル。学習中。)
...
<a href="https://github.com/Im-YuRam/TermsChecker"><img src="icon/demo-top.png" width="400" alt="Termschecker"> </a><br>
...
**✒️ 担当箇所と実装詳細**
私が設計・実装を担当した主なセクションは以下の通りです。(ABテストの状況によっては表示されないかもしれません)
